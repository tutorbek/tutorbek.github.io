...
//     <div id="archive">
//         <div class="back-row">
//             <a href="../index.html" class="text-gray-600 hover:text-gray-800 transition-colors text-lg">&larr; Back to posts</a>
//         </div>
//     </div>
//
...
//         const date = now.getDate() + " " + now.toLocaleString("en-US", {month: "long"}) + ", " + now.getFullYear() + " · " + now.toLocaleTimeString("en-US", {
//             hour: "2-digit",
//             minute: "2-digit",
//             hour12: true
//         });
...
// //     html = html.replace('{{NEXT_PATH}}', safeNext);
// //     html = html.replace('{{ERROR}}', hasError ? '<p class="error">Xato!</p>' : '');
// //
// //     return html;
// // }
// function renderLoginPage(nextPath, hasError = false) {
...
//             const cookieHeader = `${AUTH_COOKIE_NAME}=${cookieValue}; Path=/; HttpOnly; SameSite=Lax; Max-Age=86400`;
//
//             if (wantsJson) {
//                 res.writeHead(200, {
